package seleniumtesting.webapp.automation;
...
public class launchbrowser {
  ...
  public static WebDriver driver=null;
	...
	public void invokeBrowser() {
		try {
			System.setProperty("webdriver.chrome.driver", "C:\\Users\\ayush\\OneDrive\\Documents\\seleniumautomation\\seleniumtesting\\chromedriver\\chromedriver.exe");
			driver = new ChromeDriver();
			driver.manage().deleteAllCookies();
			driver.manage().window().maximize();
			//Timeouts implicitlyWait = driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
			//Timeouts pageLoadTimeout = driver.manage().timeouts().pageLoadTimeout(30, TimeUnit.SECONDS);
	...
	public void testJoinUsPage() {
		try {
			...
			driver.findElement(By.xpath("//input[@placeholder='Full Name']")).sendKeys("Ayush Kumar");
			Thread.sleep(2000);
			// Test case 6:Checking email field, email/number - //input[@placeholder='Email or Phone Number']
			driver.findElement(By.xpath("//input[@placeholder='Email or Phone Number']")).sendKeys("ayushkr0369@gmail.com");
			Thread.sleep(2000);
